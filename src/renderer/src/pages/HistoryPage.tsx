...
const HistoryPage = () => {
  ...
  const [prevDraftId, setPrevDraftId] = useState(currentDraftId)
  ...
  const selectedVersion = useMemo(() => {
    if (prdHistory.length === 0) return null
    if (!selectedVersionId) return prdHistory[0]
    return prdHistory.find((v) => v.id === selectedVersionId) || prdHistory[0]
        ...
        {prdHistory.length === 0 ? (
          ...
          <>
            ...
            <div className="w-full max-w-[800px] bg-white shadow-soft rounded-lg p-16 relative border border-stone-100 min-h-[800px] mx-12 mb-12">
              ...
              <header className="mb-12 border-b border-stone-100 pb-8 pl-8 flex justify-end">
