...
const HistoryPage = () => {
  const { prdContent, prdHistory, setPrdContent } = useStore()
  ...
  }, [selectedVersion, previousVersion, prdContent])
    ...
    <div className="flex w-full h-full bg-stone-50/50">
      <aside className="w-[480px] flex flex-col border-r border-stone-200 bg-white z-10">
        <div className="px-8 py-6 border-b border-stone-100 flex items-center justify-between">
          <div>
            <h2 className="font-serif text-2xl text-stone-900">Version History</h2>
            <p className="text-xs text-stone-400 font-medium uppercase tracking-widest mt-1">
              {prdHistory.length} Generations Total
            </p>
          </div>
          <button className="p-2 hover:bg-stone-50 rounded-lg text-stone-400 transition-colors">
            <svg
              width="20"
              height="20"
              viewBox="0 0 24 24"
          ...
          <div className="space-y-10">
            {prdHistory.length === 0 ? (
              <div className="py-20 text-center">
                ...
                <h3 className="text-sm font-semibold text-stone-900 mb-1">No History Yet</h3>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="text-sm text-stone-500 mb-3 line-clamp-2">{version.summary}</p>
                      ...
                      {isCurrent ? (
                        ...
                        <>
                          ...
                          <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                            {/* For demo purposes, we will treat 'Compare' as selecting it */}
                            <button
                              onClick={(e) => {
                                e.stopPropagation()
